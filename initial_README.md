...
This folder defines all source code for the 'AutoLoader' pipeline:
...
* Take a look at the sample under "sample_users_autoloader.py" to get familiar with the syntax.
